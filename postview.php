                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <?php
                                              ...
                                              ?>
                                                <div class="details">                  
                                                <p class="card-text"><span class="com"><i class="fa fa-comment"></i></span><i><?=$res['body']?></i>&nbsp&nbsp&nbsp<a href="postview.php?slug=<?=$slug?>&commentId=<?=$commentId?>">delete&nbsp<i class="fa fa-trash" title="delete comment" style="color: #696969;"></i></a></p>

                                                <p class="card-text">by <?=$res['patient_name']?></p>
                                                <p class="card-text"><?=$res['date']?></p><br></div>
